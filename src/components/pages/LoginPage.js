      ...
      <MDBRow>
        ...
        <MDBCol sm='6'>
          ...
          <div className='d-flex flex-column justify-content-center h-custom-2 w-75 pt-4'>
            ...
            <MDBInput wrapperClass='mb-4 mx-5 w-100' label='Email address' id='formControlLg' type='email' value={email} size="lg" onChange={e=>setEmail(e.target.value)}/>
            <MDBInput wrapperClass='mb-4 mx-5 w-100' label='Password' id='formControlLg1' type='password' value={password} size="lg" onChange={e=>setPassword(e.target.value)}/>
